...
public class Eligibility {
    ...
    void solve() {
        ...
        for (i = 0; i < n; i++) {
            String name = in.next();
            int schoolY = Integer.parseInt(in.next().substring(0,4));
            int birthY = Integer.parseInt(in.next().substring(0,4));
            int courses = in.nextInt();
            if (schoolY >= 2010 || birthY >= 1991) e = "eligible";
            else if (courses >= 41) e = "ineligible";
            else e = "coach petitions";
            out.println(name + " " + e);
        }
